...
export default function LoginPortal({
  ...
  const [isSmtpNotConfigured, setIsSmtpNotConfigured] = React.useState(false);
  const [isSmtpFailed, setIsSmtpFailed] = React.useState(false);
          ...
          <div className="pt-2">
            {!fallbackOtpSent ? (
              ...
              <div className="space-y-5 animate-fade-in">
                ...
                {isSmtpNotConfigured || isSmtpFailed ? (
