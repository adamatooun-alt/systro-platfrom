...
export const translations: Record<'ar' | 'en' | 'he', Dictionary> = {
  ...
  en: {
    ...
    fuelName: "Fuel Delivery & Refueling",
    ...
    locksmithName: "Emergency Locksmith",
    ...
    mechanicName: "Emergency Mechanics & Electrics",
